...
public class ChatHandler {
    ...
    private boolean checkUserInput (String userInput){ //is the input correct?
        return true;

    }
    private boolean checkChat (String clientNickname, String player) { //is an existing chat or not?
        return true;
    }
