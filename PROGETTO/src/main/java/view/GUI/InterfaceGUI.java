...
// La GUI è un observable, quando l'utente fa una modifica, questa deve essere notificata (NotifyObservers)
// a tutti i client, che sono gli observer.
// --------------------------------------------------------------------------------------------------------
...
public class InterfaceGUI extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(InterfaceGUI.class.getResource("GUI.fxml"));
