...
/**
 * This class represents the RMI server, which is unique.
 */
public class RMIServer extends UnicastRemoteObject implements ServerRMIInterface {
    private ServerController serverController;

    private int port = 1099; // free ports: from 49152 to 65535, 1099 default port for RMI registry
    ...
    public void startServer() throws RemoteException {
        Registry registry = LocateRegistry.createRegistry(port); // putting the server into the registry
        try {
