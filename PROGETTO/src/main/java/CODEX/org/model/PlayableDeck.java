...
public class PlayableDeck extends Deck implements Serializable {
    ...
    public static PlayableDeck goldDeck() {
        ...
        try {
            ...
            System.out.println("Error while constructing the gold deck!");
        }
    ...
    public static PlayableDeck resourceDeck() {
        ...
        try {
            ...
            System.out.println("Error while constructing the resource deck!");
        }
    ...
    public static PlayableDeck baseDeck() {
        ...
        try {
            ...
            System.out.println("Error while constructing the base deck!");
        }
