...
public class PlayableDeck extends Deck implements Serializable {
    ...
    public static PlayableDeck goldDeck(){
        ...
        File file= new File("PROGETTO/src/main/java/CODEX/org/model/jsons/goldCards.json");
        try{
    ...
    public static PlayableDeck resourceDeck(){
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        File file= new File("PROGETTO/src/main/java/CODEX/org/model/jsons/resourceCards.json");
        try{
    ...
    public static PlayableDeck baseDeck() {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        File file= new File("PROGETTO/src/main/java/CODEX/org/model/jsons/baseCards.json");
        try{
